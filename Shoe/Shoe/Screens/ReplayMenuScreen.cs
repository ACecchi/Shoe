...
namespace Shoe.Screens
{
    ...
    /// </summary>
    class ReplayMenuScreen : MenuScreen
    {
        ...
        public ReplayMenuScreen()
            : base("                Shoe has defeated the Baron Von Poppinfresh, good job!")
        {
            ...
            MenuEntry replayGameMenuEntry = new MenuEntry("Replay Game");
            MenuEntry quitGameMenuEntry = new MenuEntry("Quit Game");
            
            // Hook up menu event handlers.
            replayGameMenuEntry.Selected += ReplayGameMenuEntrySelected;
